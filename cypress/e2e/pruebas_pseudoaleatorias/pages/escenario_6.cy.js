...
context('Datos Pseudoaleatorios: Crear una Page con una palabra alfanumerica de 5 a 10 caracteres', () => {
    ...
    async function getPseudoValue() {
        try {
            ...
            for (let i = 0; i < myJson.length; i++) {
                arrayCharacterAlpha.push(myJson[i]['alphanum'].toString());
            }
    ...
    let title = (async () =>  await getPseudoValue())();
    let description = (async () =>  await getPseudoValue())();
    let urlSlug = (async () =>  await getPseudoValue())();
