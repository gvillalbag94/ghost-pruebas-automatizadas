...
context('Pseudorandom: Scenario 10 By Victor', () => {
    async function getPseudoValue() {
        try {
            ...
            for (let i = 0; i < myJson.length; i++) {
                arrayCharacterAlpha.push(myJson[i]['encrypt'].toString());
            }
    ...
    it('Create, Publish and Delete a new Draft with Encrypt register', () => {
