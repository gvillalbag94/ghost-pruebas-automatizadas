...
context('Pseudorandom: Scenario 3 By Victor', () => {
    async function getPseudoValue() {
        try {
            ...
            for (let i = 0; i < myJson.length; i++) {
                arrayCharacterAlpha.push(myJson[i]['multiple_character'].toString());
            }
    ...
    it('Create, Publish and Delete a new Draft with Multiple characters', () => {
