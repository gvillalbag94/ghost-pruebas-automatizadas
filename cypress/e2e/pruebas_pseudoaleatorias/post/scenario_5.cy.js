...
context('Pseudorandom: Scenario 5 By Victor', () => {
    async function getPseudoValue() {
        try {
            ...
            for (let i = 0; i < myJson.length; i++) {
                arrayCharacterAlpha.push(myJson[i]['ip_address'].toString());
            }
    ...
    it('Create, Publish and Delete a new Draft with ip_address', () => {
